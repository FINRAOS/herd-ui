...
import { PartitionValueFilter, AttributeValueFilter } from '@herd/angular-client';
...
export type AnyFilter = PartitionFilter | AttributeFilter | LatestValidVersionFilter;
...
export class DataObjectListFiltersComponent implements OnInit {
    ...
    ngOnInit() {
        this.filterTypes = [...this.filterTypes, this.lvvFilterType];
    }
    ...
    filterSaved(event?: any) {
        ...
        if (pValFilters.length || aValFilters.length || lvv) {
